# -*- coding:utf-8 -*-
# @File  : 12_vgg_imagenet_inference.py
# @Author: ZZW
# @Date  : 2025/2/20
"""Memintelli example 12: VGG16 in Imagenet dataset using Memintelli.
This example demonstrates the usage of Memintelli with VGG16 to load pre-trained model.
"""
import os
import sys
...
from memintelli.NN_models import VGG_zoo
...
def main():
    ...
    #   False:  ALL G on GPU (fastest, needs enough VRAM)
    #   True:   ALL G on CPU, load per-layer (lowest memory)
    ...
    model = VGG_zoo(model_name=model_name, pretrained=True, mem_enabled=mem_enabled, 
